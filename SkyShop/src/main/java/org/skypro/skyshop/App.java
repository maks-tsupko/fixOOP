...
public class App {
    public static void main(String[] args) {
        ...
        Product a1 = new ArticleProduct("Как выбрать молоко", "Разбираемся в составе и видах молока");
        Product a2 = new ArticleProduct("Польза яблок", "Почему яблоки важны для здоровья");
        Product a3 = new ArticleProduct("Скидки на хлеб", "Новые акции на хлебобулочные изделия");
